...
-- Insert genres (10)
INSERT INTO genre (creation_date, update_date, genre, version) VALUES (now(), now(), 'ADVENTURE', 0); --done
...
--insert authors
INSERT INTO author (creation_date, update_date, version, name) VALUES (now(), now(), 0, 'jack London');
INSERT INTO author (creation_date, update_date, version, name) VALUES (now(), now(), 0, 'Yann Martel');
INSERT INTO author (creation_date, update_date, version, name) VALUES (now(), now(), 0, 'Alexandre Dumas');
INSERT INTO author (creation_date, update_date, version, name) VALUES (now(), now(), 0, 'Michael Connelly');
INSERT INTO author (creation_date, update_date, version, name) VALUES (now(), now(), 0, 'Sir Arthur Conan Doyle');

-- Insert Books
INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (1, now(), now(), 0, 'NEW', 9781512395822, 5.96, 12, '2020-12-21',
        'The Call of the Wild ', 'https://m.media-amazon.com/images/I/41JNWeZqnsL._SX336_BO1,204,203,200_.jpg');

INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (1, now(), now(), 0, 'NEW', 9781512394322, 8.99, 3, '2003-04-01', 'Life Of PI',
        'https://m.media-amazon.com/images/I/51rxEvLljUL._SX322_BO1,204,203,200_.jpg');

INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (10, now(), now(), 0, 'USED', 9781505234725, 7.24, 1, '2014-12-05', 'The Three Musketeers',
        'https://m.media-amazon.com/images/I/41TxXqToCCL._SX348_BO1,204,203,200_.jpg');

INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (1, now(), now(), 0, 'USED', 9781512395822, 4.99, 5, '2022-10-03', 'The Count of Monte Cristo',
        'https://m.media-amazon.com/images/I/51wuk77r6UL.jpg');

INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (2, now(), now(), 0, 'NEW', 9780316485616, 16, 2, '2019-10-22', 'The Night Fire',
        'https://m.media-amazon.com/images/I/41zqZwXZ-WL._SX325_BO1,204,203,200_.jpg');

INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (2, now(), now(), 0, 'USED', 9780316377300,11.99, 7, '2021-11-09', 'The Dark Hours',
        'https://m.media-amazon.com/images/I/51H+yDcBXhL.jpg');

INSERT INTO book (genre_id,creation_date, update_date, version, condition, isbn, price, quantity, published_date,
                  title, img)
VALUES (2, now(), now(), 0, 'NEW', 9781508475316, 4.95, 1, '2020-12-07', 'The Adventures of Sherlock Holmes',
